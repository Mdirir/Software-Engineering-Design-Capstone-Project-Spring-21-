    ...
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <ol class="breadcrumb"><!-- breadcrumb begin -->
            <li>
                ...
                <i class="fa fa-dashboard"></i> <a href="index.php?dashboard"> Dashboard </a> / Insert Slide
...
<?php  
    ...
    if(isset($_POST['submit'])){
        ...
        if($count<5){
            ...
            $insert_slide = "insert into slider (slide_name,slide_images) values ('$slider_name','$slider_images')";
