...
<body>
    ...
    <div class="container-bg bg-light w-100" style="display:block; background:white; ">
     <p class="pt-2 ps-3">  <i class="fa fa-dashboard"></i> Dashboard / View Users / Edit User</p> <hr> </div> 
        ...
        <form action="editUser.php?id=<?php echo$_GET['id']?>" style=" margin-left:auto; margin-right: auto; " class="form-responsive" method="post" enctype="multipart/form-data">
        <?php 
                global $dbc;
                $admin_id= $_GET['id'];
                $get_products = "select * from admins where admin_id='$admin_id'";
