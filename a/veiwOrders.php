...
<body>
   <div style="margin-left:0px; margin-top:0px; position:relative"> </div>
    ...
    <div class="container-bg bg-light w-100" style="display:block; background:white; ">
     <p class="pt-2 ps-3">  <i class="fa fa-dashboard"></i> Dashboard / View Orders</p> <hr> </div>
  ...
  <thead>
    <tr>
      ...
      <th scope="col" style="border-collapse: collapse; border-right:1px solid rgba(0,0,0,.125);">Order Date</th>
      <th scope="col" style="border-collapse: collapse; border-right:1px solid rgba(0,0,0,.125);">Total Amount</th>
      <th scope="col" style="border-collapse: collapse; border-right:1px solid rgba(0,0,0,.125);">Status</th>
